...
/**
 * Error result returned when a command source fails to load.
 */
 ...
 */
export function isLoadError(result: CommandSource | LoadError): result is LoadError {
	return "success" in result && result.success === false;
}

/**
 * Loads a command source from a directory.
 ...
 */
export async function loadCommandSource(fromDir: string): Promise<CommandSource | LoadError> {
