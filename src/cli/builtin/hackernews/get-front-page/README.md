# hackernews/get-front-page

Fetch stories currently ranked on the HackerNews front page.
...
```bash
# Default: front-page stories sorted by points
websculpt hackernews get-front-page

# Get 5 front-page stories
websculpt hackernews get-front-page --limit 5

# Get 30 front-page stories sorted by most commented
websculpt hackernews get-front-page --limit 30 --sortBy comments
```
