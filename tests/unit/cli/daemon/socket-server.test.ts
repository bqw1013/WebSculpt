...
vi.mock("../../../../src/cli/daemon/browser-manager.js", async () => {
	const actual = await vi.importActual<typeof import("../../../../src/cli/daemon/browser-manager.js")>(
		"../../../../src/cli/daemon/browser-manager.js",
	);
	return {
		...actual,
...
import { createSocketServer } from "../../../../src/cli/daemon/socket-server.js";
