...
import { withBrowser } from "../../../../src/cli/daemon/browser-manager.js";

describe("executeCommand timeout", () => {
	let tempDir: string;
	let rejectEvaluate: ((reason: Error) => void) | null = null;
	let executeCommand: typeof import("../../../../src/cli/daemon/executor.js").executeCommand;
	...
	beforeEach(async () => {
		...
		vi.resetModules();
		const mod = await import("../../../../src/cli/daemon/executor.js");
