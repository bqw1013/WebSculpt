...
npx websculpt command import --from ./my-commands

# Preview the import without writing anything
npx websculpt command import --from ./my-commands --dry-run

# Overwrite existing commands with the same name
npx websculpt command import --from ./my-commands --force
```
